...
import editor.diagram.edit.parts.RelationFirstEditPart;
import editor.diagram.edit.parts.RelationSecondEditPart;

import editor.diagram.edit.parts.RelationHasEditPart;
import editor.diagram.edit.parts.RelationHaveEditPart;
 ...
 * @generated
 */
public class OpinionCanonicalEditPolicy extends CanonicalConnectionEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		EObject nextValue;
		int nodeVID;
		nextValue = ((Opinion) modelObject).getRelates();
		nodeVID = DiscussionVisualIDRegistry.getNodeVisualID(viewObject,
				nextValue);
		if (RelationEditPart.VISUAL_ID == nodeVID) {
		...
		try {
			...
			for (Iterator diagramLinks = existingLinks.iterator(); diagramLinks
				...
				EObject diagramLinkDst = nextDiagramLink.getTarget()
						.getElement();
				int diagramLinkVisualID = DiscussionVisualIDRegistry
	...
	private void collectAllLinks(View view) {
		...
		int diagramElementVisualID = DiscussionVisualIDRegistry
				.getVisualID(view);
		switch (diagramElementVisualID) {
		case RelationEditPart.VISUAL_ID:
		case OpinionEditPart.VISUAL_ID: {
	...
	private void storeFeatureModelFacetLinks(EObject container,
		...
		if (EditorPackage.eINSTANCE.getRelation().isSuperTypeOf(
				containerMetaclass)) {
			EObject nextDestination = (EObject) ((Relation) container)
					.getSecond();
			myLinkDescriptors.add(new LinkDescriptor(container,
					nextDestination,
					DiscussionElementTypes.RelationSecond_3001,
					RelationSecondEditPart.VISUAL_ID));
		...
		if (EditorPackage.eINSTANCE.getRelation().isSuperTypeOf(
			...
			EObject nextDestination = (EObject) ((Relation) container)
					.getFirst();
			myLinkDescriptors.add(new LinkDescriptor(container,
					nextDestination, DiscussionElementTypes.RelationFirst_3002,
					RelationFirstEditPart.VISUAL_ID));
