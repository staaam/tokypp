...
import editor.diagram.edit.helpers.DiscussionBaseEditHelper;

/**
 * @generated
 */
public class DiscussionBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	protected Command getSemanticCommand(IEditCommandRequest request) {
		...
		if (epCommand != null) {
			...
			completedRequest.setParameter(
					DiscussionBaseEditHelper.EDIT_POLICY_COMMAND, command);
		}
