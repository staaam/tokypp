...
import editor.diagram.edit.commands.DiscussionReorientConnectionViewCommand;

/**
 * @generated
 */
public class DiscussionGraphicalNodeEditPolicy extends GraphicalNodeEditPolicy {
	...
	protected Command getConnectionWithReorientedViewCompleteCommand(
		...
		TransactionalEditingDomain editingDomain = ((IGraphicalEditPart) getHost())
				.getEditingDomain();
		DiscussionReorientConnectionViewCommand rcvCommand = new DiscussionReorientConnectionViewCommand(
				editingDomain, null);
