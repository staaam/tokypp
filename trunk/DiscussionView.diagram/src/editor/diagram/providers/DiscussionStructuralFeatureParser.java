 ...
 * @generated
 */
public class DiscussionStructuralFeatureParser extends DiscussionAbstractParser {
	 ...
	 * @generated
	 */
	public DiscussionStructuralFeatureParser(EStructuralFeature feature) {
	...
	protected IParserEditStatus validateValues(Object[] values) {
		...
		if (value instanceof InvalidValue) {
			return new ParserEditStatus(DiscussionDiagramEditorPlugin.ID,
