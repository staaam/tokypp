 ...
 * @generated
 */
public class DiscussionInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new DiscussionNewDiagramFileWizard(mySelectedModelFile,
				myPart.getSite().getPage(), mySelection, diagramRoot,
				editingDomain);
		IDialogSettings pluginDialogSettings = DiscussionDiagramEditorPlugin
		...
		wizard.setWindowTitle("Initialize new " + OpinionEditPart.MODEL_ID
				+ " diagram file");
