...
public class EditorSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case EditorPackage.OPINION: {
				Opinion opinion = (Opinion)theEObject;
				Object result = caseOpinion(opinion);
				if (result == null) result = caseDiscussionObject(opinion);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EditorPackage.QUOTE: {
				Quote quote = (Quote)theEObject;
				Object result = caseQuote(quote);
				if (result == null) result = caseDiscussionObject(quote);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EditorPackage.RELATION: {
				Relation relation = (Relation)theEObject;
				Object result = caseRelation(relation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EditorPackage.DISCUSSION_OBJECT: {
				DiscussionObject discussionObject = (DiscussionObject)theEObject;
				Object result = caseDiscussionObject(discussionObject);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpretting the object as an instance of '<em>Discussion Object</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpretting the object as an instance of '<em>Discussion Object</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public Object caseDiscussionObject(DiscussionObject object) {
		return null;
	}
