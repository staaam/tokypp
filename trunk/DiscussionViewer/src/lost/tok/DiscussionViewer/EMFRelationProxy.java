...
public class EMFRelationProxy {
    	private RelationConnection conn_;
    	private AttributeValue[] attributeValues_;
    	
    	
    	
    	public EMFRelationProxy(){
    		conn_ = lost.tok.DiscussionViewer.emf.impl.DiscussionViewerFactoryImpl.eINSTANCE.createRelationConnection();
    		init();
    	}
    	
    	public EMFRelationProxy(RelationConnection con){
    		conn_ = con;
    		init();
    	}
