...
public class DiscussionViewer extends org.gems.designer.model.LinkedModel  implements Adapter, EMFModelObject, org.gems.designer.model.EMFModelElement{

	private lost.tok.DiscussionViewer.emf.DiscussionViewer model_;
	private Notifier target_;
	
	public DiscussionViewer(){		
	}
	
	public DiscussionViewer(lost.tok.DiscussionViewer.emf.DiscussionViewer model){
		model_ = model;
	...
	public lost.tok.DiscussionViewer.emf.DiscussionViewer getModel(){
		if(model_ == null){
			model_ = lost.tok.DiscussionViewer.emf.impl.DiscussionViewerFactoryImpl.eINSTANCE.createDiscussionViewer();
			super.setName(model_.getName());
			model_.eAdapters().add(this);
		}
		return model_;
	...
	public lost.tok.DiscussionViewer.emf.DiscussionViewer getExtendedModel(){
		return getModel();
	}
	
	public lost.tok.DiscussionViewer.emf.DiscussionViewer getEMFObject(){
		return getModel();
	}
    ...
    public static final IPropertyDescriptor[] DISCUSSIONVIEWER_ATTRIBUTE_DESCRIPTORS =
    {
    };
    public static final Object[] DISCUSSIONVIEWER_DEFAULT_ATTRIBUTE_VALUES = {
    ...
    protected void getPropertyDescriptors(Vector desc){
    	desc.addAll(java.util.Arrays.asList(DISCUSSIONVIEWER_ATTRIBUTE_DESCRIPTORS));
...
public void accept(Visitor visitor) {
   if(visitor instanceof DiscussionViewerVisitor)
   	((DiscussionViewerVisitor)visitor).visitDiscussionViewer(this);
   else
