 ...
 * <ul>
 *   <li>{@link lost.tok.DiscussionViewer.emf.impl.ModelObjectImpl#getName <em>Name</em>}</li>
 *   <li>{@link lost.tok.DiscussionViewer.emf.impl.ModelObjectImpl#getId <em>Id</em>}</li>
 *   <li>{@link lost.tok.DiscussionViewer.emf.impl.ModelObjectImpl#getX <em>X</em>}</li>
 *   <li>{@link lost.tok.DiscussionViewer.emf.impl.ModelObjectImpl#getY <em>Y</em>}</li>
 *   <li>{@link lost.tok.DiscussionViewer.emf.impl.ModelObjectImpl#getWidth <em>Width</em>}</li>
 *   <li>{@link lost.tok.DiscussionViewer.emf.impl.ModelObjectImpl#getHeight <em>Height</em>}</li>
 *   <li>{@link lost.tok.DiscussionViewer.emf.impl.ModelObjectImpl#getExpandedWidth <em>Expanded Width</em>}</li>
 *   <li>{@link lost.tok.DiscussionViewer.emf.impl.ModelObjectImpl#getExpandedHeight <em>Expanded Height</em>}</li>
 *   <li>{@link lost.tok.DiscussionViewer.emf.impl.ModelObjectImpl#isExpanded <em>Expanded</em>}</li>
 *   <li>{@link lost.tok.DiscussionViewer.emf.impl.ModelObjectImpl#isSubtype <em>Subtype</em>}</li>
 *   <li>{@link lost.tok.DiscussionViewer.emf.impl.ModelObjectImpl#isVisible <em>Visible</em>}</li>
 *   <li>{@link lost.tok.DiscussionViewer.emf.impl.ModelObjectImpl#getModelLinkTarget <em>Model Link Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ModelObjectImpl extends EObjectImpl implements ModelObject
{
  ...
  {
    return DiscussionViewerPackage.Literals.MODEL_OBJECT;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DiscussionViewerPackage.MODEL_OBJECT__NAME, oldName, name));
  }
  ...
  public void setId(String newId)
  {
    ...
    id = newId;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DiscussionViewerPackage.MODEL_OBJECT__ID, oldId, id));
  }
  ...
  public void setX(int newX)
  {
    ...
    x = newX;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DiscussionViewerPackage.MODEL_OBJECT__X, oldX, x));
  }
  ...
  public void setY(int newY)
  {
    ...
    y = newY;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DiscussionViewerPackage.MODEL_OBJECT__Y, oldY, y));
  }
  ...
  public void setWidth(int newWidth)
  {
    ...
    width = newWidth;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DiscussionViewerPackage.MODEL_OBJECT__WIDTH, oldWidth, width));
  }
  ...
  public void setHeight(int newHeight)
  {
    ...
    height = newHeight;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DiscussionViewerPackage.MODEL_OBJECT__HEIGHT, oldHeight, height));
  }
  ...
  public void setExpandedWidth(int newExpandedWidth)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DiscussionViewerPackage.MODEL_OBJECT__EXPANDED_WIDTH, oldExpandedWidth, expandedWidth));
  }
  ...
  public void setExpandedHeight(int newExpandedHeight)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DiscussionViewerPackage.MODEL_OBJECT__EXPANDED_HEIGHT, oldExpandedHeight, expandedHeight));
  }
  ...
  public void setExpanded(boolean newExpanded)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DiscussionViewerPackage.MODEL_OBJECT__EXPANDED, oldExpanded, expanded));
  }
  ...
  public void setSubtype(boolean newSubtype)
  {
    ...
    subtype = newSubtype;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DiscussionViewerPackage.MODEL_OBJECT__SUBTYPE, oldSubtype, subtype));
  }
  ...
  public void setVisible(boolean newVisible)
  {
    ...
    visible = newVisible;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DiscussionViewerPackage.MODEL_OBJECT__VISIBLE, oldVisible, visible));
  }
  ...
  public void setModelLinkTarget(String newModelLinkTarget)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DiscussionViewerPackage.MODEL_OBJECT__MODEL_LINK_TARGET, oldModelLinkTarget, modelLinkTarget));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DiscussionViewerPackage.MODEL_OBJECT__NAME:
        return getName();
      case DiscussionViewerPackage.MODEL_OBJECT__ID:
        return getId();
      case DiscussionViewerPackage.MODEL_OBJECT__X:
        return new Integer(getX());
      case DiscussionViewerPackage.MODEL_OBJECT__Y:
        return new Integer(getY());
      case DiscussionViewerPackage.MODEL_OBJECT__WIDTH:
        return new Integer(getWidth());
      case DiscussionViewerPackage.MODEL_OBJECT__HEIGHT:
        return new Integer(getHeight());
      case DiscussionViewerPackage.MODEL_OBJECT__EXPANDED_WIDTH:
        return new Integer(getExpandedWidth());
      case DiscussionViewerPackage.MODEL_OBJECT__EXPANDED_HEIGHT:
        return new Integer(getExpandedHeight());
      case DiscussionViewerPackage.MODEL_OBJECT__EXPANDED:
        return isExpanded() ? Boolean.TRUE : Boolean.FALSE;
      case DiscussionViewerPackage.MODEL_OBJECT__SUBTYPE:
        return isSubtype() ? Boolean.TRUE : Boolean.FALSE;
      case DiscussionViewerPackage.MODEL_OBJECT__VISIBLE:
        return isVisible() ? Boolean.TRUE : Boolean.FALSE;
      case DiscussionViewerPackage.MODEL_OBJECT__MODEL_LINK_TARGET:
