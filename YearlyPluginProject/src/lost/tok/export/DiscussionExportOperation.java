...
public class DiscussionExportOperation  implements IRunnableWithProgress {
     ...
     *  @param filename java.lang.String
     */
    public DiscussionExportOperation(IResource res, List resources, String filename) {
        this(res, filename);
        resourcesToExport = resources;
    }
    ...
    protected void initialize() throws IOException {
    	   	exporter = new DiscussionZipFileExporter(destinationFilename, useCompression);
    }
