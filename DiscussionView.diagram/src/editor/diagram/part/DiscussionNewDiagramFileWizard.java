 ...
 * @generated
 */
public class DiscussionNewDiagramFileWizard extends Wizard {
	 ...
	 * @generated
	 */
	public DiscussionNewDiagramFileWizard(IFile selectedModelFile,
			IWorkbenchPage workbenchPage, IStructuredSelection selection,
			EObject diagramRoot, TransactionalEditingDomain editingDomain) {
		assert selectedModelFile != null : "Null selectedModelFile in DiscussionNewDiagramFileWizard constructor"; //$NON-NLS-1$
		assert workbenchPage != null : "Null workbenchPage in DiscussionNewDiagramFileWizard constructor"; //$NON-NLS-1$
		assert selection != null : "Null selection in DiscussionNewDiagramFileWizard constructor"; //$NON-NLS-1$
		assert diagramRoot != null : "Null diagramRoot in DiscussionNewDiagramFileWizard constructor"; //$NON-NLS-1$
		assert editingDomain != null : "Null editingDomain in DiscussionNewDiagramFileWizard constructor"; //$NON-NLS-1$
	...
	public void addPages() {
		myFileCreationPage = new WizardNewFileCreationPage(
			...
			public void createControl(Composite parent) {
				...
				String originalFileName = mySelectedModelFile
						...
						.lastSegment();
				String fileExtension = ".editor_diagram"; //$NON-NLS-1$
		...
		myFileCreationPage.setDescription("Create new diagram based on "
				+ OpinionEditPart.MODEL_ID + " model content");
	...
	public boolean performFinish() {
		...
		AbstractTransactionalCommand command = new AbstractTransactionalCommand(
			...
			protected CommandResult doExecuteWithResult(
				...
				int diagramVID = DiscussionVisualIDRegistry
						.getDiagramVisualID(myDiagramRoot);
				if (diagramVID != OpinionEditPart.VISUAL_ID) {
	...
	private class RootElementSelectorPage extends WizardPage implements
		...
		private void createModelBrowser(Composite parent) {
			...
			treeViewer.setContentProvider(new AdapterFactoryContentProvider(
					DiscussionDiagramEditorPlugin.getInstance()
