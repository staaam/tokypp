 ...
 * @generated
 */
public class DiscussionDiagramFileCreator extends IDEEditorFileCreator {

	/**
	 * @generated
	 */
	private static DiscussionDiagramFileCreator INSTANCE = new DiscussionDiagramFileCreator();
	...
	public String getExtension() {
		return ".editor_diagram"; //$NON-NLS-1$
	}
	...
	private String appendExtensionToModelFileName(String fileName) {
		return fileName + ".editor"; //$NON-NLS-1$
	}
